...
[![npm version](https://img.shields.io/npm/v/math-mcp.svg)](https://www.npmjs.com/package/math-mcp)
...
```javascript
// Determinant
matrix({ op: "determinant", a: [[1,2],[3,4]] })
// → -2

// Inverse
matrix({ op: "inverse", a: [[4,7],[2,6]] })
// → [[0.6,-0.7],[-0.2,0.4]]

// Eigenvalues
matrix({ op: "eigenvalues", a: [[2,1],[1,2]] })
// → [3, 1]
